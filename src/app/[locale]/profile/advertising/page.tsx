...
export default function AdvertisingSpacePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 py-16 px-8 flex flex-col items-center text-center gap-4">
        ...
        <p className="text-gray-500 max-w-md leading-relaxed">{t("text")}</p>
        <Link
          href="/profile/points"
        ...
        <Link href="/profile" className="mt-1 inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-600 transition-colors">
